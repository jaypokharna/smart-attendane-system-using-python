...
def markAttendance(name):
    with open("Attendance/"+combo.get()+"_"+x+".csv",'r+') as f:
...
def startprogram():
    ...
    f=open("Attendance/"+combo.get()+"_"+x+".csv",'w')
...
#login button
loginButton = Button(tkWindow, text="Login", command=validateLogin).place(x=100,y=100)

#attendance button
attendancebutton = Button(tkWindow2, text="Start Attendance", command=finalPage).place(x=77,y=105)
...
#stop attendance
quitLable = Label(tkWindow2, text="Press F to stop attendance").place(x=68,y=135)
